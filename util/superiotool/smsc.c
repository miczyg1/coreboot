...
static const struct superio_registers reg_table[] = {
	...
	{0xc4, "SCH5545", {
		...
		{EOT}}},
	{0x03, "MEC5055", {
		{0x0, "Mailbox interface",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x1, "Keyboard",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x2, "ACPI EC channel 1",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x3, "ACPI EC channel 2",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x4, "ACPI EC channel 3",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x5, "ACPI EC channel 4",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x6, "ACPI EC channel 5",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x7, "COM1",
			{ 0x30, 0xf0, EOT},
		...
		{0x0c, "LPC Interface",
			...
			{0x00,
			 ...
			 0x0f, 0x10, 0x00, 0x00,
			 EOT}},
		{0xe, "Embedded Flash Interface",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0xe, "Embedded Memory Interface",
			{ 0x30, EOT},
			{ 0x00, EOT}},
		{0x3f, "Global Configuration",
			{ 0x20, 0x21, 0x24, EOT},
			{ MISC, MISC, 0x00, EOT}},
		{EOT}}},
	{EOT}
