...
/**
 * Sets the EC interrupt mask for LSB in the Interrupt Mask reigster.
 */
void sch5545_emi_set_int_mask_low(uint8_t mask);
/**
 * Sets the EC interrupt mask for MSB in the Interrupt Mask reigster.
 */
 ...
 */
void sch5545_emi_ec_write32_bulk(uint16_t addr, const uint32_t *data,
				 size_t len);
/**
